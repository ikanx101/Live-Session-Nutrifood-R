...
Setelah itu, kita akan aplikasikan _function_ tersebut ke data yang ada dengan menggunakan:
...
Mari kita buat analisa mengenai seberapa populer vide tersebut di Youtube! Setidaknya, kita akan menghitung `3` parameter baru, yakni:
...
vids.u = 
  ...
  mutate(
    ...
    commentration = comment_count/views * 100
  )
```
