...
Misalkan saya definisikan $x_i$ sebagai banyaknya gula $i$ yang dibeli untuk memenuhi $D$. Lalu karena Nutrifood tidak ada kewajiban membeli semua gula yang ada, maka:

$x_i$ bisa bernilai:

- $x_i = 0$ __atau__ 
- $\text{min_order}_i \leq x_i \leq \text{max_cap}$.

Untuk itu, saya akan definisikan satu variabel $y_i$ berupa _binary_:

$$y_i = \begin{cases} 1 & x_i=0,\\ 0 & \text{min_order}_i \leq x_i \leq \text{max_cap}\end{cases}$$

$$\forall k \in K \text{ kecuali } \{1,6\}, \, \forall  i \in P_j, \, \forall k \in G,$$
