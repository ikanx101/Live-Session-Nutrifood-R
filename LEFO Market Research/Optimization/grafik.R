...
jadwal = readxl::read_excel("ppic.xlsx", sheet = "Contoh Kasus")
...
jadwal %>% 
  ...
  labs(title = "Ilustrasi Pemesanan Gula",
  ...
  theme(legend.position = "none",
        plot.background = element_rect(fill = "#d9bab8", color = NA),
...
ggsave("ilustrasi.png", width = 15, height = 7)
