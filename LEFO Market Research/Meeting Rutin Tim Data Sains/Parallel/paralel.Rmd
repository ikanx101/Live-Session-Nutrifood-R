...
Linux adalah _operating system_ berbasis UNIX (sama halnya dengan MacOS) yang bersifat _open source_. Dibuat oleh seorang _programmer_ bernama Linus Torvalds pada 1991. Sampai saat ini, OS Linux merupakan OS yang populer digunakan di berbagai _server_ dan _high performance computer_ di dunia.
...
Di _gadget_ Android, kita bisa mencicipi Linux CLI dan GUI dengan meng-_install_ _apps_ bernama `userLand`. Pada laptop Windows, kita bisa meng-_install_ berbagai _virtual toolbox_ (misalkan `MobaXterm`).
