...
<div class="my-footer"><span>POK 2021</span></div>
...
_Only  if it's a variation that caused by special cause_.
...
1. Tentukan hipotesis nol dan hipotesis tandingan.
  - Notasi: H0 dan H1
  - Hipotesis nol adalah hipotesis yang mengandung unsur __sama dengan__.
2. Contoh pada t-test dua sampel:
  - H0: rata - rata dari dua sampel yang dites sama.
  - H1: rata - rata dari dua sampel yang dites berbeda. 
3. Hitung statistik uji atau p-value.
4. Kesimpulan: Tolak H0 jika p-value < 0.05.
5. Tuliskan kesimpulan dengan kalimat non matematis.
]
