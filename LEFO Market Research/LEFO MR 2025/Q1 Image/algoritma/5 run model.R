...
# semua list files
al  = list.files(folder_all[grepl("al",folder_all,ignore.case = T)],full.names = T)
el  = list.files(folder_all[grepl("el",folder_all,ignore.case = T)],full.names = T)
dul = list.files(folder_all[grepl("dul",folder_all,ignore.case = T)],full.names = T)
...
model <- load_model("model_v10.keras")
